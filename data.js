...
const CARDS = [
  ...
  //   isMainChar: false,       // true = this card can only be placed as the Main Character slot
  //   isSideChar: false,       // true = this card can only be placed as a Side Character slot
  // },
];
